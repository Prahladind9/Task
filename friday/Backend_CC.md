...
We kindly ask you to solve the following code challenge (in Java or Kotlin) as part of our selection process.
...
Write a running application in the programming language of your choice including test cases and send the source code back to jobs@friday.de. Please ensure to include a quick note in your mail which programming language you used so that we can give you quick & valuable feedback afterwards.